 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $property = null, $randomize = true, $word = null, $gray = false)
 * @method string image($dir = null, $width = 640, $height = 480, $property = null, $fullPath = true, $randomize = true, $word = null)
 *
